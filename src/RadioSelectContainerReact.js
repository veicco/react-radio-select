...
class RadioSelectContainerReact extends RadioSelectContainer {
...
RadioSelectContainerReact.propTypes = {
...
RadioSelectContainerReact.defaultProps = {
  required: false,
  defaultOption: 0
};

export default RadioSelectContainerReact;